        ...
        public partial struct XNonuple
        {
            ...
            public override String ToString()
            {
                return String.Join('\n'.ToString(), new String[] {
                    ...
                    String.Empty + '\t' + '~' + "16" + ' ' + nameof(Identity) + ':' + ' ' + "<hidden>",
                    String.Empty + '\t' + '~' + "17" + ' ' + nameof(Identity) + ':' + ' ' + Identity.ValueSafe,
                    String.Empty + '\t' + '~' + "18" + ' ' + nameof(Link) + ':' + ' ' + "<hidden>",
                    String.Empty + '\t' + '~' + "19" + ' ' + nameof(Link) + ':' + ' ' + Link.ValueSafe,
                    String.Empty + '}',
                    String.Empty,
