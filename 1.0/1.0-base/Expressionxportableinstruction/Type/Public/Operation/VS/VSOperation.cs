...
namespace Core
{
    ...
    {
        public void VSOperation(String Filename_VALUE, Stack value_STACK, String[] Parameter_ARRAY, String[] Split_ARRAY, String[] SplitTruncate__ARRAY, String Lower_VALUE)
        {
            IView(this);
